...
mag.S = log10(apply(eqexp[S,], 2, max) - apply(eqexp[S,], 2, min))# denote which columns are earthquakes and explosions and NZ
...
cat(d.slopes[1], "mag.P" , d.slopes[2], "mag.S +" , d.inter, " = ", d,"\n")
cat("P(NZ=EQ|data) =", post.eq, " P(NZ=EX|data) =", 1-post.eq, "\n" )
```
